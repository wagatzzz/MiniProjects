...
const Results = ({ results }) => {
    return (
        <div className="bg-cyan-900 text-white p-4 rounded-r-lg w-full h-96 flex flex-col justify-center items-center shadow-2xl">
            {results ? (
                results.type === 'repayment' ? (
                    <>
                        <div className="flex flex-col bg-cyan-950 p-4 rounded-lg">
                            <div className="mb-4">
                ...
                <div>
                    <h3 className="text-2xl font-semibold px-20">Results shown here</h3>
